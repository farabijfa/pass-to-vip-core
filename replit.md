...
The PassKit service (`server/services/passkit.service.ts`) connects to the PassKit API at `https://api.pub1.passkit.io`.
...
- **PassKit Production Integration** (2025-12-03)
  ...
  - Updated `passkit.service.ts` with real API calls to `https://api.pub1.passkit.io`
